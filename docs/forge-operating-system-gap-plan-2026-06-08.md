...
- Cost ledger agora materializa histórico normalizado em `cost_ledger_index`; ainda falta backfill automático contínuo e retenção/agregação histórica por período.
