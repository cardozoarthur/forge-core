...
- Cost ledger agora materializa histórico normalizado em `cost_ledger_index` e expõe rollups por período em `forge.cost_ledger_history.v1`; ainda falta backfill automático contínuo, retenção física e política de agregação incremental.
