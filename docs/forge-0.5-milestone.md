...
| Live collaboration | planned | Human decision audit and durable interaction state exist; scheduler/loop MCP visibility is validated through 0.4.112. | Need presence, cursors/selections, patch streams, comments, conflict handling and rollback demo before 0.5 promotion. |
...
| Export/demo baseline | planned | Daily Goal smoke produces Markdown/PDF as scheduler validation; this is not creative runtime proof. | Need one design/tokens/component workflow demo and one structured document/slide/whiteboard workflow demo before 0.5 promotion. |
