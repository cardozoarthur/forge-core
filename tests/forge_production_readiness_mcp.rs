...
fn production_readiness_mcp_tools_are_explicitly_read_only() {
    ...
    let plan = manifest
        .tools
        .iter()
        .find(|tool| tool.name == "forge.milestone.production_plan")
    ...
    let readiness = manifest
        .tools
        .iter()
        .find(|tool| tool.name == "forge.milestone.production_readiness")
...
fn incomplete_manifest() -> Value {
    let now = SystemTime::now()
        ...
        .as_secs();
    json!({
        "schema_version": "forge.milestone.production_readiness_manifest.v1",
        "milestone": "0.5",
        ...
        "off_host_backup": {
            ...
            "forge_key_isolated_from_uploader": false,
            "uploader_credentials_isolated_from_forge": false
        },
        "key_escrow": {
        ...
        "mission_operational_lifecycle": {
            ...
            "capability_inventory_schema_version": "forge.mission_platform.catalog.v1",
        ...
        "execute_receipt_schema_version": "forge.mission.execution_receipt.v3",
            ...
            "submit_receipt_schema_version": "forge.mission.submit.v1",
            ...
            "resume_receipt_schema_version": "forge.mission.drive.v1",
