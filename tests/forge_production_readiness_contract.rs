...
fn production_readiness_passes_only_complete_fresh_secret_free_evidence() {
    ...
    assert_eq!(
        ...
        "forge.milestone.production_evidence.release_matrix.v2"
    );
}
...
fn current_release_rejects_legacy_unbound_receipts() {
    ...
    receipt["schema_version"] = "forge.milestone.production_evidence.release_matrix.v1".into();
...
fn production_evidence_assembly_is_explicit_source_bound_and_fail_closed() {
    ...
    assert_eq!(
        ...
        "forge.milestone.production_evidence.bounded_load.v2"
    );
    assert_eq!(
...
fn initialize_mission_repository(repository: &Path) -> String {
    ...
    fs::write(
        ...
        concat!(
            "[package]\n",
            "name = \"forge-production-lifecycle-fixture\"\n",
            "version = \"0.1.0\"\n",
            "edition = \"2021\"\n",
            "\n",
            "[lib]\n",
    ...
    for kind in [
        ...
        let mut source_bytes = serde_json::to_vec(&serde_json::json!({
            "schema_version": format!(
                "forge.milestone.production_source_evidence.{kind}.v1"
            ),
            "kind": kind,
            "status": "passed",
            ...
            "producer": "forge-production-readiness-contract-fixture",
            "claims": claims,
            "evidence": {
        ...
        let receipt = serde_json::json!({
            "schema_version": format!("forge.milestone.production_evidence.{kind}.v2"),
            "kind": kind,
            "status": "passed",
            "subject_version": manifest.release_version,
