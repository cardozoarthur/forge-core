...
fn initialize_repository(repository: &Path) {
    ...
    git(
        repository,
        &["config", "user.name", "Foundry Parallel Team Tests"],
    );
...
fn foundry() -> AssertCommand {
    AssertCommand::cargo_bin("foundry").expect("foundry binary should build")
}
