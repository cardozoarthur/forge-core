...
use forge_core::mission::simulate_mission;
use forge_core::mission_platform::simulate_mission_platform_with_store;
...
fn capability_catalog_exposes_all_forty_numbered_backend_contracts() {
    ...
    assert_eq!(json["schema_version"], "forge.mission_platform.catalog.v1");
...
fn bounded_platform_simulation_fails_closed_without_a_worktree_binding() {
    ...
    assert_eq!(
        json["schema_version"],
        "forge.mission_platform.simulation.v1"
    );
