...
fn build_quota_policy(
    ...
    let mut candidates = vec![
        quota_candidate(
            ...
            "medium",
            "medium_high",
            "good_for_product_and_code_when_free_quota_is_available",
            "medium",
            10,
            "OpenCode non-local free provider path is the first choice when expected value justifies configured free capacity.",
        ),
        quota_candidate(
            executors,
            &observations,
