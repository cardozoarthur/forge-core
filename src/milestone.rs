...
fn next_action_for_gap(capability_id: &str) -> &'static str {
    match capability_id {
        ...
        "replacement_grade_cli" => {
            "Integrate patch slash commands deeper into the TUI with inline diff rendering, multi-file review, provider/session management and end-to-end coding/research workflows."
        }
        "experimental_multimodal_runtime" => {
