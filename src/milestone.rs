...
fn next_action_for_gap(capability_id: &str) -> &'static str {
    match capability_id {
        ...
        "replacement_grade_cli" => {
            "Extend `forge patch plan` into native file editing apply/revert execution, in-TUI diff review, provider/session selection and permission-gated shell execution."
        }
        "experimental_multimodal_runtime" => {
