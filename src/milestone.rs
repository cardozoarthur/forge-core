...
fn required_evidence_for(capability_id: &str) -> &'static str {
    match capability_id {
        ...
        "replacement_grade_cli" => {
            "Forge-first CLI demo evidence plus native file editing, inline patch workbench previews, multi-file review queues, diff review, permissions, sessions, harness session lifecycle plans and JSON-stable automation evidence."
        }
        "experimental_multimodal_runtime" => {
...
fn next_action_for_gap(capability_id: &str) -> &'static str {
    match capability_id {
        ...
        "replacement_grade_cli" => {
            "Continue from patch workbench multi-file review queues into deeper provider/session controls and end-to-end coding/research workflows."
        }
        "experimental_multimodal_runtime" => {
