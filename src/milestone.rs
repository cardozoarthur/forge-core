...
fn forge_05_capabilities() -> Vec<MilestoneCapability> {
    vec![
        ...
        capability(
            ...
            "validated",
            "0.4.92-0.4.96 validate cron nodes, loop state, due execution, missed-run policy and daily Goal research smoke artifacts.",
        ...
        capability(
            ...
            "planned",
            "Requirements are captured in self-evolution prompt v2 and the milestone document.",
            "Need working structured IR for screens, whiteboards, documents/slides and component manifests.",
        ),
        capability(
            "design_tokens",
            ...
            "planned",
            "Requirements are captured in self-evolution prompt v2 and the milestone document.",
            "Need token schema, semantic resolution, inheritance, propagation and human edit preservation demos.",
        ),
        capability(
            ...
            "planned",
            "Requirements are captured in self-evolution prompt v2 and the milestone document.",
            "Need component manifest, variants/states/actions, token dependencies and patch-by-intent demo.",
        ),
        capability(
            "live_collaboration",
            "Live collaboration",
