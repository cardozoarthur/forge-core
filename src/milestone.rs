...
fn next_action_for_gap(capability_id: &str) -> &'static str {
    match capability_id {
        ...
        "replacement_grade_cli" => {
            "Extend patch apply/revert into in-TUI diff review, explicit human approval execution, provider/session selection and permission-gated shell execution."
        }
        "experimental_multimodal_runtime" => {
