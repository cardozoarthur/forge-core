    ...
    McpToolsManifest {
        ...
        tools: vec![
            ...
            tool(
                ...
                "Return the Forge interactive file-editing and diff-review workbench with Git status, diff checks, approval-flow gates and permission-gated patch lifecycle commands without mutating files.",
                object_schema(&[], &[]),
