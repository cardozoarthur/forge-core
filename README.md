...
- harness utilities for token-headroom analysis, Forge-first CLI wrapper planning and reversible stdout/stderr headroom receipts across Codex, Claude, Gemini and OpenCode-style executors
