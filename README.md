...
- SQLite-materialized event observability index over the global event timeline, grouped by tenant, workflow, node and Addon with duration, retry and wait aggregates
