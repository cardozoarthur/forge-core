...
- harness utilities for token-headroom analysis, Forge-first CLI wrapper planning, non-destructive PATH shim installation, shim status auditing, reversible stdout/stderr headroom receipts and workflow timeline events across Codex, Claude, Gemini and OpenCode-style executors
