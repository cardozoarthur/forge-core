...
- 0.5 milestone status, promotion manifest, evidence-plan, collect-evidence and attached-evidence ledger surfaces for release-gate inspection, including secret-free `manifest_templates` for missing project evidence manifests such as `.forge/connected-brain-runtimes.json`, `.forge/multimodal.json` and `.forge/multimodal-runtimes.json`
