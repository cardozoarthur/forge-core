...
5. `forge interactive architecture` mostra a bússola entre goal1/goal2/goal3, evidências atuais, gaps, dependências, reuso e benchmarks.
...
- architecture compass through `forge interactive architecture` and MCP `forge.interactive.architecture`, exposing the goal1/goal2/goal3 source document hashes, architecture tracks, implementation evidence, gaps, dependencies, reuse opportunities, benchmark boundaries and next commands without mutating state
